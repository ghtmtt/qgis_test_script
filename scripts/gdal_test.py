...
d_gdal['aspect']['commit'] = [gh_link + 'eab5ae28ec2a5dcbbccfd17d8d3ddda376b53c16', gh_link + '6adbb8b7f5ba14326f83ce9b6eb72bc5']

d_gdal['cliprasterbyextent']['test'] = ['yes']
d_gdal['cliprasterbyextent']['parameter'] = ['standard', 'change NULL values']
d_gdal['cliprasterbyextent']['commit'] = [gh_link + 'eab5ae28ec2a5dcbbccfd17d8d3ddda376b53c16', gh_link + '6adbb8b7f5ba14326f83ce9b6eb72bc5']
...
d_gdal['cliprasterbymasklayer']['commit'] = [gh_link + 'eab5ae28ec2a5dcbbccfd17d8d3ddda376b53c16', gh_link + '6adbb8b7f5ba14326f83ce9b6eb72bc5']

d_gdal['hillshade']['test'] = ['yes']
d_gdal['hillshade']['parameter'] = ['standard', 'with edges', 'zevenbergen']
d_gdal['hillshade']['commit'] = [gh_link + 'eab5ae28ec2a5dcbbccfd17d8d3ddda376b53c16', gh_link + '6adbb8b7f5ba14326f83ce9b6eb72bc5']

d_gdal['slope']['test'] = ['yes']
d_gdal['slope']['parameter'] = ['standard', 'with edges', 'zevenbergen', 'percent instead of degree']
d_gdal['slope']['commit'] = [gh_link + 'eab5ae28ec2a5dcbbccfd17d8d3ddda376b53c16', gh_link + '6adbb8b7f5ba14326f83ce9b6eb72bc5']

d_gdal['roughness']['test'] = ['yes']
d_gdal['roughness']['parameter'] = ['standard', 'with edges']
d_gdal['roughness']['commit'] = [gh_link + '64f2b660fdb34a447e072777727fe578dac44087']

d_gdal['triterrainruggednessindex']['test'] = ['yes']
d_gdal['triterrainruggednessindex']['parameter'] = ['standard', 'with edges']
d_gdal['triterrainruggednessindex']['commit'] = [gh_link + 'ad11ec4b7f04d5c3f6ff1bffb2f6fd48ba96bf70']

d_gdal['nearblack']['test'] = ['yes']
d_gdal['nearblack']['parameter'] = ['standard']
d_gdal['nearblack']['commit'] = [gh_link + '1f645c19968603a443839a67dd2b7e9e526f2c76']

d_gdal['tpitopographicpositionindex']['test'] = ['yes']
d_gdal['tpitopographicpositionindex']['parameter'] = ['standard', 'with edges']
d_gdal['tpitopographicpositionindex']['commit'] = [gh_link + 'eb826fb058189cbfc43bc822bcd5088c198c090a']
